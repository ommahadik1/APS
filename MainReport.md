...
- **Resolution**: Minimum 4MP (2688×1520)
- **Frame rate**: 30fps for traffic monitoring
- **Lens**: Variable focal length (8-32mm)
- **Night vision**: IR capability up to 100 meters
- **Weather protection**: IP67 rating minimum

#### 6.3.2 Processing Hardware
- **Edge AI processors**: NVIDIA Jetson series or equivalent
- **RAM**: Minimum 8GB for real-time processing
- **Storage**: 1TB SSD for local data buffering
- **Connectivity**: 4G/5G modem for data transmission

#### 6.3.3 Supporting Infrastructure
- **Power supply**: 200W capacity with solar backup
- **Network equipment**: Managed switches and routers
- **Mounting systems**: Weatherproof camera poles
- **Control room setup**: Central monitoring stations
